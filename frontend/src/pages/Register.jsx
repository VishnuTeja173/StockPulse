...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: "var(--night)" }}>
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full blur-[120px] pointer-events-none opacity-20" style={{ background: "#6ee7b7" }}></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full blur-[120px] pointer-events-none opacity-20" style={{ background: "#60a5fa" }}></div>
      ...
      <div className="w-full max-w-md fade-up">
        <div className="card p-8 text-center" style={{ border: "1px solid rgba(255,255,255,0.05)", background: "rgba(19, 19, 26, 0.7)", backdropFilter: "blur(20px)" }}>
          ...
          <p className="text-sm mb-8" style={{ color: "var(--muted)" }}>Join StockPulse to build your intelligent portfolio.</p>
          ...
          <p className="mt-8 text-xs" style={{ color: "var(--muted)" }}>
            Already have an account? <Link to="/login" className="font-bold text-white hover:underline" style={{ color: "#60a5fa" }}>Log in</Link>
          </p>
        </div>
      </div>
    </div>
